...
public class ProductController {
    ...
    // Get the list of products by Category -> filtering by categoryId or categoryName or any other field
    ...
    // Get the list of products by keyword -> search
    ...
    // Update the product and present the updated product
    ...
    // To update the image of the product
